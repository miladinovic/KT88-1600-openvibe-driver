...
CConfigurationContecKT88::CConfigurationContecKT88(IDriverContext& rDriverContext, const char* sGtkBuilderFileName, OpenViBE::uint32& rUSBIndex)
...
CConfigurationContecKT88::~CConfigurationContecKT88(void)
{
	g_object_unref(m_pListStore);
}

boolean CConfigurationContecKT88::preConfigure(void)
{
...
boolean CConfigurationContecKT88::postConfigure(void)
{
	::GtkComboBox* l_pComboBox=GTK_COMBO_BOX(gtk_builder_get_object(m_pBuilderConfigureInterface, "combobox_device"));
	...
	if(m_bApplyConfiguration)
	{
		...
		if(l_iUSBIndex>=0)
		{
			m_rUSBIndex=(uint32)l_iUSBIndex1;
		}
	}
